...
| WEB_CLIENT_EGRESS_TIMEOUT_CONNECT            | 60000                   |  false   | Connect timeout in milliseconds for the egress web client used for outgoing requests to other modules.                                                                                          |
| WEB_CLIENT_EGRESS_TIMEOUT_KEEP_ALIVE         | 60                      |  false   | Keep-alive timeout in seconds for the egress web client.                                                                                                                                        |
| WEB_CLIENT_EGRESS_TIMEOUT_IDLE               | 0                       |  false   | Idle timeout in seconds for the egress web client. `0` disables the timeout. Can be increased to work around idle connections being closed by load balancers, e.g. when uploading large files.  |
| WEB_CLIENT_EGRESS_TIMEOUT_READ_IDLE          | 0                       |  false   | Read idle timeout in seconds for the egress web client. `0` disables the timeout.                                                                                                               |
| WEB_CLIENT_EGRESS_TIMEOUT_WRITE_IDLE         | 0                       |  false   | Write idle timeout in seconds for the egress web client. `0` disables the timeout.                                                                                                              |
| WEB_CLIENT_INGRESS_TIMEOUT_CONNECT           | 60000                   |  false   | Connect timeout in milliseconds for the ingress web client used for forwarding requests to the underlying module.                                                                               |
| WEB_CLIENT_INGRESS_TIMEOUT_KEEP_ALIVE        | 60                      |  false   | Keep-alive timeout in seconds for the ingress web client.                                                                                                                                       |
| WEB_CLIENT_INGRESS_TIMEOUT_IDLE              | 0                       |  false   | Idle timeout in seconds for the ingress web client. `0` disables the timeout.                                                                                                                   |
| WEB_CLIENT_INGRESS_TIMEOUT_READ_IDLE         | 0                       |  false   | Read idle timeout in seconds for the ingress web client. `0` disables the timeout.                                                                                                              |
| WEB_CLIENT_INGRESS_TIMEOUT_WRITE_IDLE        | 0                       |  false   | Write idle timeout in seconds for the ingress web client. `0` disables the timeout.                                                                                                             |
